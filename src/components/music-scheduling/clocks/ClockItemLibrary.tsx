          ...
          {libraryItems
            ...
            .map((item) => {
              ...
              return (
                  <div 
                    key={item.id as string}
                    className="clock-item-library__item clock-item-library__item--clickable"
                    onClick={() => onAddItem(itemType, dragData)}
                  >
                    <div className="clock-item-library__item-icon">
