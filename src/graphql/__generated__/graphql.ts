...
export type ScheduleQuery = { __typename?: 'Query', schedule: { __typename?: 'ScheduleList', total: number, items: Array<{ __typename?: 'ScheduleItem', id: number, start: any, end: any, networks: Array<{ __typename?: 'Network', id: number, name: string }>, episode: { __typename?: 'Episode', name: string, show: { __typename?: 'Show', shortName: string }, broadcasts: Array<{ __typename?: 'Broadcast', id: number, start: any, end: any }> } }> } };
