...
export type GetEpisodeQuery = { __typename?: 'Query', episode?: { __typename?: 'Episode', id: string, name: string, description: string, extraData?: string | null, shortId: string, createdAt: string, updatedAt: string, url: string, duration: { __typename?: 'EpisodeDuration', formatted: string, raw: number }, featuredImage: { __typename?: 'Media', id: string, key: string, urls: { __typename?: 'MediaUrls', medium: string, square: string } }, show: { __typename?: 'Show', id: string, shortName: string }, series?: { __typename?: 'Series', id: string, shortName: string } | null, presenters: Array<{ __typename?: 'Presenter', id: string, name: string }>, networks: Array<{ __typename?: 'Network', id: string, name: string, logoSvgIcon: string }> } | null };
...
export type GetMediaQuery = { __typename?: 'Query', media: { __typename?: 'Media', id: string, key: string, type: MediaType, mimeType: string, createdAt: string, updatedAt: string, fileSize?: { __typename?: 'MediaFileSize', label: string, raw: number } | null, urls: { __typename?: 'MediaUrls', medium: string, square: string, original: string } } };
...
export type SearchMediaQuery = { __typename?: 'Query', mediaList: { __typename?: 'MediaList', total: number, items: Array<{ __typename?: 'Media', id: string, key: string, type: MediaType, mimeType: string, createdAt: string, fileSize?: { __typename?: 'MediaFileSize', label: string, raw: number } | null, urls: { __typename?: 'MediaUrls', medium: string, square: string, original: string } }> } };
...
export type GetPresentersQuery = { __typename?: 'Query', presentersV2: { __typename?: 'PresenterList', total: number, items: Array<{ __typename?: 'Presenter', id: string, name: string, picture?: string | null }> } };
...
export type GetShowQuery = { __typename?: 'Query', show?: { __typename?: 'Show', createdAt: string, extraData?: string | null, fullDesc: string, fullName: string, hidden: boolean, id: string, shortDesc: string, shortId: string, shortName: string, totalEpisodes: number, updatedAt: string, url: string, featuredImage: { __typename?: 'Media', id: string, key: string, urls: { __typename?: 'MediaUrls', medium: string, square: string } }, networks: Array<{ __typename?: 'Network', id: string, name: string, logoSvgIcon: string }>, presenters: Array<{ __typename?: 'Presenter', id: string, name: string }>, series: { __typename?: 'SeriesList', items: Array<{ __typename?: 'Series', id: string, fullName: string }> } } | null };
