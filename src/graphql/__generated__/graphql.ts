...
export type GetNetworksQuery = { __typename?: 'Query', networks: Array<{ __typename?: 'Network', id: string, name: string, code: string, baseUrl: string, imagesUrl: string, logoSvg: string, logoSvgCircular?: string | null, logoSvgColor?: string | null, logoSvgIcon: string, networkType: NetworkType, tagline?: string | null, cssUrl?: string | null, playFormat?: string | null, playUrl?: string | null, shortId: string, logoMedia?: { __typename?: 'Media', id: string, key: string, mimeType: string, type: MediaType, urls: { __typename?: 'MediaUrls', original: string, medium: string, square: string }, fileSize?: { __typename?: 'MediaFileSize', label: string } | null } | null, logoIconMedia?: { __typename?: 'Media', id: string, key: string, mimeType: string, type: MediaType, urls: { __typename?: 'MediaUrls', original: string, medium: string, square: string }, fileSize?: { __typename?: 'MediaFileSize', label: string } | null } | null, logoLightMedia?: { __typename?: 'Media', id: string, key: string, mimeType: string, type: MediaType, urls: { __typename?: 'MediaUrls', original: string, medium: string, square: string }, fileSize?: { __typename?: 'MediaFileSize', label: string } | null } | null }> };
...
export type GetNetworkQuery = { __typename?: 'Query', network: { __typename?: 'Network', id: string, name: string, code: string, baseUrl: string, imagesUrl: string, logoSvg: string, logoSvgCircular?: string | null, logoSvgColor?: string | null, logoSvgIcon: string, networkType: NetworkType, tagline?: string | null, cssUrl?: string | null, playFormat?: string | null, playUrl?: string | null, shortId: string, logoMedia?: { __typename?: 'Media', id: string, key: string, mimeType: string, type: MediaType, urls: { __typename?: 'MediaUrls', original: string, medium: string, square: string }, fileSize?: { __typename?: 'MediaFileSize', label: string } | null } | null, logoIconMedia?: { __typename?: 'Media', id: string, key: string, mimeType: string, type: MediaType, urls: { __typename?: 'MediaUrls', original: string, medium: string, square: string }, fileSize?: { __typename?: 'MediaFileSize', label: string } | null } | null, logoLightMedia?: { __typename?: 'Media', id: string, key: string, mimeType: string, type: MediaType, urls: { __typename?: 'MediaUrls', original: string, medium: string, square: string }, fileSize?: { __typename?: 'MediaFileSize', label: string } | null } | null } };
