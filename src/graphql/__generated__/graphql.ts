...
export type GetShowQuery = { __typename?: 'Query', show?: { __typename?: 'Show', createdAt: string, extraData?: string | null, fullDesc: string, fullName: string, hidden: boolean, id: string, shortDesc: string, shortId: string, shortName: string, updatedAt: string, url: string, featuredImage: { __typename?: 'Media', id: string, key: string, urls: { __typename?: 'MediaUrls', medium: string, square: string } }, networks: Array<{ __typename?: 'Network', id: string, name: string, logoSvgIcon: string }>, presenters: Array<{ __typename?: 'Presenter', id: string, name: string }>, series: { __typename?: 'SeriesList', items: Array<{ __typename?: 'Series', id: string, fullName: string }> } } | null };
