...
export type ArticleBlock = BlockBase & {
...
export type Block = ArticleBlock | FeaturedEpisodesBlock | FeaturedNetworksBlock | FeaturedPresentersBlock | FeaturedShowsBlock | FeaturedSubcategoriesBlock | FeaturedTracksBlock | ImageBlock | MediaBlock | RecentArticlesBlock | RecommendationsBlock | RichContentBlock;
...
export enum BlockType {
  ...
  FeaturedNetworks = 'FEATURED_NETWORKS',
  FeaturedPresenters = 'FEATURED_PRESENTERS',
  FeaturedShows = 'FEATURED_SHOWS',
  FeaturedSubcategories = 'FEATURED_SUBCATEGORIES',
...
export type CreateNetworkInput = {
  ...
  logoIconMediaId?: InputMaybe<Scalars['ID']['input']>;
  logoLightMediaId?: InputMaybe<Scalars['ID']['input']>;
...
export type CreatePageInput = {
  description?: InputMaybe<Scalars['String']['input']>;
  isActive?: InputMaybe<Scalars['Boolean']['input']>;
  isInNavigation?: InputMaybe<Scalars['Boolean']['input']>;
  kind?: InputMaybe<PageKind>;
  metaData?: InputMaybe<Scalars['JSON']['input']>;
  navOrder?: InputMaybe<Scalars['Int']['input']>;
  networkId: Scalars['ID']['input'];
...
/** Featured episodes via curated IDs or filters */
export type FeaturedEpisodesBlock = BlockBase & {
  __typename?: 'FeaturedEpisodesBlock';
  createdAt: Scalars['DateTime']['output'];
  description?: Maybe<Scalars['String']['output']>;
  id: Scalars['ID']['output'];
  isActive: Scalars['Boolean']['output'];
...
/** Featured episodes via curated IDs or filters */
export type FeaturedEpisodesBlockItemsArgs = {
  limit?: InputMaybe<Scalars['Int']['input']>;
};
...
export type FeaturedNetworksBlock = BlockBase & {
  __typename?: 'FeaturedNetworksBlock';
  createdAt: Scalars['DateTime']['output'];
  description?: Maybe<Scalars['String']['output']>;
  id: Scalars['ID']['output'];
  isActive: Scalars['Boolean']['output'];
...
export type FeaturedNetworksBlockItemsArgs = {
  limit?: InputMaybe<Scalars['Int']['input']>;
};

export type FeaturedPresentersBlock = BlockBase & {
  __typename?: 'FeaturedPresentersBlock';
  createdAt: Scalars['DateTime']['output'];
  description?: Maybe<Scalars['String']['output']>;
  id: Scalars['ID']['output'];
  isActive: Scalars['Boolean']['output'];
...
export type FeaturedPresentersBlockItemsArgs = {
  limit?: InputMaybe<Scalars['Int']['input']>;
};

/** Featured shows via curated IDs or filters */
export type FeaturedShowsBlock = BlockBase & {
  __typename?: 'FeaturedShowsBlock';
  createdAt: Scalars['DateTime']['output'];
  description?: Maybe<Scalars['String']['output']>;
  id: Scalars['ID']['output'];
  isActive: Scalars['Boolean']['output'];
...
/** Featured shows via curated IDs or filters */
export type FeaturedShowsBlockItemsArgs = {
  limit?: InputMaybe<Scalars['Int']['input']>;
};
...
export type FeaturedSubcategoriesBlock = BlockBase & {
  __typename?: 'FeaturedSubcategoriesBlock';
  createdAt: Scalars['DateTime']['output'];
  description?: Maybe<Scalars['String']['output']>;
  id: Scalars['ID']['output'];
  isActive: Scalars['Boolean']['output'];
...
export type FeaturedSubcategoriesBlockItemsArgs = {
  limit?: InputMaybe<Scalars['Int']['input']>;
};

export type FeaturedTracksBlock = BlockBase & {
  __typename?: 'FeaturedTracksBlock';
  createdAt: Scalars['DateTime']['output'];
  description?: Maybe<Scalars['String']['output']>;
  id: Scalars['ID']['output'];
  isActive: Scalars['Boolean']['output'];
...
export type FeaturedTracksBlockItemsArgs = {
  limit?: InputMaybe<Scalars['Int']['input']>;
};
...
export type NavigationItem = {
  ...
  label: Scalars['String']['output'];
  page?: Maybe<Page>;
  staticCorePage?: Maybe<StaticCorePage>;
};

/** Kinds of navigation entries */
export enum NavigationItemKind {
  Group = 'GROUP',
  Page = 'PAGE',
  Special = 'SPECIAL',
  StaticCore = 'STATIC_CORE'
}
...
export type Network = {
  ...
  /** Whether this network is premium */
  isPremium: Scalars['Boolean']['output'];
  /** Icon version of logo media asset for the network */
  logoIconMedia?: Maybe<Media>;
  /** Light version of logo media asset for the network */
  logoLightMedia?: Maybe<Media>;
  /** Logo media asset for the network */
  ...
  name: Scalars['String']['output'];
  /** Primary site navigation for this network */
  navigation: Array<NavigationItem>;
  /** Type of network */
  networkType: NetworkType;
  /** Parent network if this is a child network */
  parent?: Maybe<Network>;
  ...
  /** Related networks (siblings with same parent network) */
  relatedNetworks: NetworkList;
  shortId: Scalars['String']['output'];
  tagline?: Maybe<Scalars['String']['output']>;
};


export type NetworkNavigationArgs = {
  includeCore?: InputMaybe<Scalars['Boolean']['input']>;
};


export type NetworkRelatedNetworksArgs = {
  filters?: InputMaybe<NetworkListInputV2>;
};

export type NetworkBooleanFilter = {
  field: NetworkBooleanFilterField;
  operator: BooleanFilterOperator;
  value: Scalars['Boolean']['input'];
};

export enum NetworkBooleanFilterField {
  IsParentNetwork = 'isParentNetwork',
  NonBroadcast = 'nonBroadcast'
}

export type NetworkDateFilter = {
  field: NetworkDateFilterField;
  operator: DateFilterOperator;
  value?: InputMaybe<Scalars['DateTime']['input']>;
  values?: InputMaybe<Array<Scalars['DateTime']['input']>>;
};

export enum NetworkDateFilterField {
  CreatedAt = 'createdAt',
  UpdatedAt = 'updatedAt'
}

export type NetworkFilterGroup = {
  filters?: InputMaybe<Array<NetworkFilterInput>>;
  groups?: InputMaybe<Array<NetworkFilterGroup>>;
  operator: OperatorType;
};

export type NetworkFilterInput = {
  booleanFilter?: InputMaybe<NetworkBooleanFilter>;
  dateFilter?: InputMaybe<NetworkDateFilter>;
  multiOptionFilter?: InputMaybe<NetworkMultiOptionFilter>;
  numberFilter?: InputMaybe<NetworkNumberFilter>;
  optionFilter?: InputMaybe<NetworkOptionFilter>;
  textFilter?: InputMaybe<NetworkTextFilter>;
  type: NetworkFilterType;
};

export enum NetworkFilterType {
  Boolean = 'BOOLEAN',
  Date = 'DATE',
  MultiOption = 'MULTI_OPTION',
  Number = 'NUMBER',
...
export type NetworkList = ItemList & {
  __typename?: 'NetworkList';
  items: Array<Network>;
  total: Scalars['Int']['output'];
};

export type NetworkListInputV2 = {
  filterGroup?: InputMaybe<NetworkFilterGroup>;
  limit?: InputMaybe<Scalars['Int']['input']>;
  offset?: InputMaybe<Scalars['Int']['input']>;
  order?: InputMaybe<Array<NetworkOrder>>;
};

export type NetworkMultiOptionFilter = {
  field: NetworkMultiOptionFilterField;
  operator: MultiOptionFilterOperator;
  values: Array<Scalars['ID']['input']>;
};

export enum NetworkMultiOptionFilterField {
  Episodes = 'episodes',
  NetworkType = 'networkType',
  Presenters = 'presenters',
  Series = 'series',
...
export type NetworkNumberFilter = {
  field: NetworkNumberFilterField;
  operator: NumberFilterOperator;
  value?: InputMaybe<Scalars['Int']['input']>;
  values?: InputMaybe<Array<Scalars['Int']['input']>>;
};

export enum NetworkNumberFilterField {
  NoFieldsAvailable = '_NO_FIELDS_AVAILABLE'
}

export type NetworkOptionFilter = {
  field: NetworkOptionFilterField;
  operator: OptionFilterOperator;
  value?: InputMaybe<Scalars['String']['input']>;
  values?: InputMaybe<Array<Scalars['String']['input']>>;
};

export enum NetworkOptionFilterField {
  Code = 'code',
  Id = 'id',
  NetworkType = 'networkType',
  NonBroadcast = 'nonBroadcast'
...
export type NetworkTextFilter = {
  field: NetworkTextFilterField;
  operator: TextFilterOperator;
  value: Scalars['String']['input'];
};

export enum NetworkTextFilterField {
  BaseUrl = 'baseUrl',
  Code = 'code',
  ImagesUrl = 'imagesUrl',
  Name = 'name',
...
export type Page = {
  ...
  id: Scalars['ID']['output'];
  isActive: Scalars['Boolean']['output'];
  isInNavigation: Scalars['Boolean']['output'];
  /** How the frontend should render this page */
  kind: PageKind;
  metaData?: Maybe<Scalars['JSON']['output']>;
  navOrder: Scalars['Int']['output'];
  network: Network;
  networkId: Scalars['ID']['output'];
  shortId: Scalars['String']['output'];
...
export type RecentArticlesBlock = BlockBase & {
  __typename?: 'RecentArticlesBlock';
  createdAt: Scalars['DateTime']['output'];
  description?: Maybe<Scalars['String']['output']>;
  id: Scalars['ID']['output'];
  isActive: Scalars['Boolean']['output'];
...
export type RecentArticlesBlockItemsArgs = {
  limit?: InputMaybe<Scalars['Int']['input']>;
};
...
export type RecommendationsBlock = BlockBase & {
  __typename?: 'RecommendationsBlock';
  createdAt: Scalars['DateTime']['output'];
  description?: Maybe<Scalars['String']['output']>;
  id: Scalars['ID']['output'];
  isActive: Scalars['Boolean']['output'];
...
export type RecommendationsBlockItemsArgs = {
  limit?: InputMaybe<Scalars['Int']['input']>;
};
...
/** A rich content block with advanced, nested elements */
...
/** Rich content creation input (stored in JSON config) */
export type RichContentConfigInput = {
  nodes: Array<Scalars['JSON']['input']>;
  title?: InputMaybe<Scalars['String']['input']>;
};

/** Advanced rich content schema (recursive) */
export type RichNode = {
  __typename?: 'RichNode';
  attrs?: Maybe<Scalars['JSON']['output']>;
  children?: Maybe<Array<RichNode>>;
  episode?: Maybe<Episode>;
...
export enum RichNodeType {
  Column = 'COLUMN',
  Divider = 'DIVIDER',
  FeaturedEpisode = 'FEATURED_EPISODE',
  FeaturedNetwork = 'FEATURED_NETWORK',
  FeaturedPresenter = 'FEATURED_PRESENTER',
  FeaturedShow = 'FEATURED_SHOW',
...
/** Static core routes provided by the frontend app */
export enum StaticCorePage {
  Presenters = 'PRESENTERS',
...
export type UpdateMusicClockMutation = { __typename?: 'Mutation', updateMusicClock: { __typename?: 'MusicClockMutationOutput', success: boolean, message?: string | null, clock?: { __typename?: 'MusicClock', id: string, name: string, description?: string | null, color: string, targetRuntime: number, network: { __typename?: 'Network', id: string, name: string }, items: Array<{ __typename?: 'AdBreakClockItem', id: string, clockId: string, createdAt: string, duration: number, orderIndex: number, updatedAt: string, scheduledStartTime: any } | { __typename?: 'CommandClockItem', id: string, clockId: string, createdAt: string, duration: number, orderIndex: number, updatedAt: string, command: string } | { __typename?: 'GenreClockItem', id: string, clockId: string, createdAt: string, duration: number, orderIndex: number, updatedAt: string, genre: { __typename?: 'Genre', id: string, name: string } } | { __typename?: 'LibraryAdBreakClockItem', id: string, clockId: string, createdAt: string, duration: number, orderIndex: number, updatedAt: string, adBreak: { __typename?: 'MusicClockLibraryAdBreak', id: string, duration: number, scheduledStartTime: string } } | { __typename?: 'LibraryCommandClockItem', id: string, clockId: string, createdAt: string, duration: number, orderIndex: number, updatedAt: string, libraryCommand: { __typename?: 'MusicClockLibraryCommand', id: string, duration: number, command: string } } | { __typename?: 'LibraryNoteClockItem', id: string, clockId: string, createdAt: string, duration: number, orderIndex: number, updatedAt: string, note: { __typename?: 'MusicClockLibraryNote', id: string, duration: number, label: string, content: string } } | { __typename?: 'NoteClockItem', id: string, clockId: string, createdAt: string, duration: number, orderIndex: number, updatedAt: string, label?: string | null, content: string } | { __typename?: 'SubcategoryClockItem', id: string, clockId: string, createdAt: string, duration: number, orderIndex: number, updatedAt: string, subcategory: { __typename?: 'Subcategory', id: string, name: string, color?: string | null, category: { __typename?: 'Category', id: string, name: string } } } | { __typename?: 'TrackClockItem', id: string, clockId: string, createdAt: string, duration: number, orderIndex: number, updatedAt: string, track: { __typename?: 'Track', id: string, title: string, artist: string } }> } | null } };
...
export type GetMediaQuery = { __typename?: 'Query', media: { __typename?: 'Media', id: string, key: string, type: MediaType, mimeType: string, fileSize?: { __typename?: 'MediaFileSize', label: string, raw: number } | null, urls: { __typename?: 'MediaUrls', original: string, medium: string, square: string } } };
...
export type SearchMediaQuery = { __typename?: 'Query', mediaList: { __typename?: 'MediaList', total: number, items: Array<{ __typename?: 'Media', id: string, key: string, type: MediaType, mimeType: string, fileSize?: { __typename?: 'MediaFileSize', label: string, raw: number } | null, urls: { __typename?: 'MediaUrls', original: string, medium: string, square: string } }> } };
...
export type GetNetworksQuery = { __typename?: 'Query', networks: Array<{ __typename?: 'Network', id: string, name: string, code: string, baseUrl: string, imagesUrl: string, logoSvg: string, logoSvgCircular?: string | null, logoSvgColor?: string | null, logoSvgIcon: string, networkType: NetworkType, isPremium: boolean, tagline?: string | null, cssUrl?: string | null, playFormat?: string | null, playUrl?: string | null, shortId: string, logoMedia?: { __typename?: 'Media', id: string, key: string, mimeType: string, type: MediaType, urls: { __typename?: 'MediaUrls', original: string, medium: string, square: string }, fileSize?: { __typename?: 'MediaFileSize', label: string } | null } | null, logoIconMedia?: { __typename?: 'Media', id: string, key: string, mimeType: string, type: MediaType, urls: { __typename?: 'MediaUrls', original: string, medium: string, square: string }, fileSize?: { __typename?: 'MediaFileSize', label: string } | null } | null, logoLightMedia?: { __typename?: 'Media', id: string, key: string, mimeType: string, type: MediaType, urls: { __typename?: 'MediaUrls', original: string, medium: string, square: string }, fileSize?: { __typename?: 'MediaFileSize', label: string } | null } | null }> };
...
export type GetNetworkQuery = { __typename?: 'Query', network: { __typename?: 'Network', id: string, name: string, code: string, baseUrl: string, imagesUrl: string, logoSvg: string, logoSvgCircular?: string | null, logoSvgColor?: string | null, logoSvgIcon: string, networkType: NetworkType, isPremium: boolean, tagline?: string | null, cssUrl?: string | null, playFormat?: string | null, playUrl?: string | null, shortId: string, logoMedia?: { __typename?: 'Media', id: string, key: string, mimeType: string, type: MediaType, urls: { __typename?: 'MediaUrls', original: string, medium: string, square: string }, fileSize?: { __typename?: 'MediaFileSize', label: string } | null } | null, logoIconMedia?: { __typename?: 'Media', id: string, key: string, mimeType: string, type: MediaType, urls: { __typename?: 'MediaUrls', original: string, medium: string, square: string }, fileSize?: { __typename?: 'MediaFileSize', label: string } | null } | null, logoLightMedia?: { __typename?: 'Media', id: string, key: string, mimeType: string, type: MediaType, urls: { __typename?: 'MediaUrls', original: string, medium: string, square: string }, fileSize?: { __typename?: 'MediaFileSize', label: string } | null } | null, parent?: { __typename?: 'Network', id: string, name: string } | null } };
...
export type UniversalClockItemSearchQueryVariables = Exact<{
...
export type UniversalClockItemSearchQuery = { __typename?: 'Query', tracksV2: { __typename?: 'TrackList', items: Array<{ __typename?: 'Track', id: string, artist: string, title: string, album: string, duration: { __typename?: 'TrackDuration', formatted: string, raw: number }, genre?: { __typename?: 'Genre', id: string, name: string } | null, subcategory?: { __typename?: 'Subcategory', id: string, name: string, color?: string | null, category: { __typename?: 'Category', id: string, name: string } } | null }> }, genresV2: { __typename?: 'GenreList', items: Array<{ __typename?: 'Genre', id: string, name: string }> }, subcategories: Array<{ __typename?: 'Subcategory', id: string, name: string, color?: string | null, averageDuration?: { __typename?: 'TrackDuration', raw: number, formatted: string } | null, category: { __typename?: 'Category', id: string, name: string } }>, libraryNotes: { __typename?: 'MusicClockItemLibraryList', items: Array<{ __typename?: 'MusicClockLibraryAdBreak' } | { __typename?: 'MusicClockLibraryCommand' } | { __typename?: 'MusicClockLibraryNote', id: string, label: string, content: string, duration: number, createdAt: string, updatedAt: string }> }, libraryCommands: { __typename?: 'MusicClockItemLibraryList', items: Array<{ __typename?: 'MusicClockLibraryAdBreak' } | { __typename?: 'MusicClockLibraryCommand', id: string, label: string, command: string, duration: number, createdAt: string, updatedAt: string } | { __typename?: 'MusicClockLibraryNote' }> }, libraryAdBreaks: { __typename?: 'MusicClockItemLibraryList', items: Array<{ __typename?: 'MusicClockLibraryAdBreak', id: string, duration: number, scheduledStartTime: string, createdAt: string, updatedAt: string } | { __typename?: 'MusicClockLibraryCommand' } | { __typename?: 'MusicClockLibraryNote' }> } };
...
export const UniversalClockItemSearchDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"UniversalClockItemSearch"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"searchTerm"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"networkId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"limit"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}},"defaultValue":{"kind":"IntValue","value":"20"}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"tracksV2"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"filters"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"limit"},"value":{"kind":"Variable","name":{"kind":"Name","value":"limit"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"filterGroup"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"operator"},"value":{"kind":"EnumValue","value":"OR"}},{"kind":"ObjectField","name":{"kind":"Name","value":"filters"},"value":{"kind":"ListValue","values":[{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"type"},"value":{"kind":"EnumValue","value":"TEXT"}},{"kind":"ObjectField","name":{"kind":"Name","value":"textFilter"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"field"},"value":{"kind":"EnumValue","value":"title"}},{"kind":"ObjectField","name":{"kind":"Name","value":"operator"},"value":{"kind":"EnumValue","value":"CONTAINS"}},{"kind":"ObjectField","name":{"kind":"Name","value":"value"},"value":{"kind":"Variable","name":{"kind":"Name","value":"searchTerm"}}}]}}]},{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"type"},"value":{"kind":"EnumValue","value":"TEXT"}},{"kind":"ObjectField","name":{"kind":"Name","value":"textFilter"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"field"},"value":{"kind":"EnumValue","value":"artist"}},{"kind":"ObjectField","name":{"kind":"Name","value":"operator"},"value":{"kind":"EnumValue","value":"CONTAINS"}},{"kind":"ObjectField","name":{"kind":"Name","value":"value"},"value":{"kind":"Variable","name":{"kind":"Name","value":"searchTerm"}}}]}}]}]}}]}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"items"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"artist"}},{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"album"}},{"kind":"Field","name":{"kind":"Name","value":"duration"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"formatted"}},{"kind":"Field","name":{"kind":"Name","value":"raw"}}]}},{"kind":"Field","name":{"kind":"Name","value":"genre"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}}]}},{"kind":"Field","name":{"kind":"Name","value":"subcategory"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"color"}},{"kind":"Field","name":{"kind":"Name","value":"category"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}}]}}]}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"genresV2"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"filters"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"limit"},"value":{"kind":"Variable","name":{"kind":"Name","value":"limit"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"filterGroup"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"operator"},"value":{"kind":"EnumValue","value":"AND"}},{"kind":"ObjectField","name":{"kind":"Name","value":"filters"},"value":{"kind":"ListValue","values":[{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"type"},"value":{"kind":"EnumValue","value":"TEXT"}},{"kind":"ObjectField","name":{"kind":"Name","value":"textFilter"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"field"},"value":{"kind":"EnumValue","value":"name"}},{"kind":"ObjectField","name":{"kind":"Name","value":"operator"},"value":{"kind":"EnumValue","value":"CONTAINS"}},{"kind":"ObjectField","name":{"kind":"Name","value":"value"},"value":{"kind":"Variable","name":{"kind":"Name","value":"searchTerm"}}}]}}]}]}}]}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"items"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"subcategories"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"filters"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"limit"},"value":{"kind":"Variable","name":{"kind":"Name","value":"limit"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"name"},"value":{"kind":"Variable","name":{"kind":"Name","value":"searchTerm"}}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"color"}},{"kind":"Field","name":{"kind":"Name","value":"averageDuration"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"raw"}},{"kind":"Field","name":{"kind":"Name","value":"formatted"}}]}},{"kind":"Field","name":{"kind":"Name","value":"category"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}}]}}]}},{"kind":"Field","alias":{"kind":"Name","value":"libraryNotes"},"name":{"kind":"Name","value":"musicClockItemLibrary"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"networkId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"networkId"}}},{"kind":"Argument","name":{"kind":"Name","value":"type"},"value":{"kind":"EnumValue","value":"NOTE"}},{"kind":"Argument","name":{"kind":"Name","value":"search"},"value":{"kind":"Variable","name":{"kind":"Name","value":"searchTerm"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"items"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"MusicClockLibraryNote"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"label"}},{"kind":"Field","name":{"kind":"Name","value":"content"}},{"kind":"Field","name":{"kind":"Name","value":"duration"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"updatedAt"}}]}}]}}]}},{"kind":"Field","alias":{"kind":"Name","value":"libraryCommands"},"name":{"kind":"Name","value":"musicClockItemLibrary"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"networkId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"networkId"}}},{"kind":"Argument","name":{"kind":"Name","value":"type"},"value":{"kind":"EnumValue","value":"COMMAND"}},{"kind":"Argument","name":{"kind":"Name","value":"search"},"value":{"kind":"Variable","name":{"kind":"Name","value":"searchTerm"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"items"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"MusicClockLibraryCommand"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"label"}},{"kind":"Field","name":{"kind":"Name","value":"command"}},{"kind":"Field","name":{"kind":"Name","value":"duration"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"updatedAt"}}]}}]}}]}},{"kind":"Field","alias":{"kind":"Name","value":"libraryAdBreaks"},"name":{"kind":"Name","value":"musicClockItemLibrary"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"networkId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"networkId"}}},{"kind":"Argument","name":{"kind":"Name","value":"type"},"value":{"kind":"EnumValue","value":"AD_BREAK"}},{"kind":"Argument","name":{"kind":"Name","value":"search"},"value":{"kind":"Variable","name":{"kind":"Name","value":"searchTerm"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"items"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"MusicClockLibraryAdBreak"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"duration"}},{"kind":"Field","name":{"kind":"Name","value":"scheduledStartTime"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"updatedAt"}}]}}]}}]}}]}}]} as unknown as DocumentNode<UniversalClockItemSearchQuery, UniversalClockItemSearchQueryVariables>;